...
MODEL_PATH = "sft_output/Qwen3-TTS-12Hz-1.7B-Base/exp3/checkpoint-epoch-7"
...
wavs, sr = tts.generate_custom_voice(
    ...
    text="상담사연결이 가능한시간은 평일 오전아홉시부터 오후여섯시까지이며, 점심시간은 오후열두시부터 오후한시까지입니다.",
